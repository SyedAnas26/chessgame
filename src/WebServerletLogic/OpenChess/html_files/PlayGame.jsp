...
$("#chess_board").ready(function() {
    ...
    $(document).ready(function(){
        $("#next_step").click(function(){
            $.ajax({
                url: "http://localhost:8080/nextstep",
                type: 'POST',
                success: function(response) {
					uiManager.nextOrPrev='n';
	...
	$(document).ready(function(){
		$("#previous_step").click(function(){
			$.ajax({
				url: "http://localhost:8080/previous_step",
				type: 'POST',
				success: function(response) {

					uiManager.nextOrPrev='p';
					uiManager.cellClickedAt(response.to_pos);
					uiManager.cellClickedAt(response.from_pos);
				}
	...
	<% request.getSession().setAttribute("NewOrOld","New"); %>
	});
...
<input type="button" id="next_step" value="Next Step" cellpadding="0" cellspacing="0"/>
<br>
<br>
<input type="button" id="previous_step" value="Previous Step" cellpadding="0" cellspacing="0"/>
<br>
<br>
<input type="button" id="start_again" value="Start Again" cellpadding="0" cellspacing="0"/>
<br>
