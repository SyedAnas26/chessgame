...
public class GameMain {
    public static void main(String[] args) throws Exception {
        new GameManager();
       /* String gamePlay="1.e4 c6 2.c4 d5 3.exd5 cxd5 4.cxd5 Nf6 5.Nc3 Nxd5 6.d4 Nc6 7.Nf3 e6 8.Bd3 Be7 " +
        ...
        String[] gamePlayAsArray=gamePlay.trim().split(" |\\.");
        for(String s:gamePlayAsArray){
